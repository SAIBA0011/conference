        ...
        <div class="container">
            <div class="col-sm-2 col-xs-12 navigation-header">
                <a href="{{ route('homepage') }}" class="logo">
                    <img src="/assets/img/africa.png" alt="VentCamp" class="retina-hide hidden-sm hidden-xs hidden-md" style=" width: 29%; position: relative; bottom: 10px; left: 130px;">
                    <img src="/assets/img/africa.png" alt="VentCamp" class="retina-show hidden-sm hidden-xs hidden-md" style=" width: 29%; position: relative; bottom: 10px; left: 130px;">
                </a>
            ...
            <div class="col-sm-10 col-xs-12 navigation-container">
                <div id="navigation" class="navbar-collapse collapse">
                    ...
                    <a href="#" class="pull-right buy-btn" data-modal-link="email-ticket">Buy Tickets</a>
                </div>
            </div>
        </div>
    </div>
